# Requirements Archive: v2.2 UX & Access Control
...
- [x] **ACCESS-01**: Signup validates email against approved list from environment variable
- [x] **ACCESS-02**: Non-approved emails receive error message on signup attempt
- [x] **ACCESS-03**: Approved email list supports comma-separated format
- [x] **ACCESS-04**: Existing login functionality works unchanged for approved users
...
**Notes:**
- All export requirements validated with markdown download and format testing
- All navigation requirements validated with pathname-based active state detection
- All access control requirements validated with environment variable configuration and email validation
