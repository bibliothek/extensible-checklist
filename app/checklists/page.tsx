    ...
    <main className="min-h-screen p-4 sm:p-6 md:p-12 lg:p-24">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2">Active Checklists</h1>
            <p className="text-gray-600 dark:text-gray-400">Manage and complete your checklists</p>
          </div>
          <Link
            href="/checklists/new"
